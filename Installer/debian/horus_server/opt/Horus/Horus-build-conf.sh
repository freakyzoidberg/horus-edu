...
CONF="[General]\nVersion=0.1\nLessonsDirectoryPath=~/.Horus/Lessons\n\n[Plugins]\nUserDirectoryPath=/home/zoidberg/.Horus/Plugins\nLoad=libCourse.so, libPdfController.so, libTextController.so, libLessonManager.so, libdispPDF.so, libTreeManagement.so, libMainFrame.so, libAdministration.so\n\n[Network]\nServer=localhost\nPort=42000\nPortTransfert=42042\n"
