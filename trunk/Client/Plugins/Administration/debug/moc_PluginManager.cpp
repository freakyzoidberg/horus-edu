...
**
** Created: Thu 1. Oct 11:21:21 2009
...
const QMetaObject PluginManager::staticMetaObject = {
    { &AbstractManager::staticMetaObject, qt_meta_stringdata_PluginManager,
...
void *PluginManager::qt_metacast(const char *_clname)
{
    ...
    return AbstractManager::qt_metacast(_clname);
}

int PluginManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AbstractManager::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
