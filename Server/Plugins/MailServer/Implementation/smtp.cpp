...
void smtp::setFrom(const QString &from)
{
    _from = from;
    _fromName = from;
    _replyTo = from;
...
void smtp::setEncoding(Encoding encoding)
{
    switch(encoding) {
...
QString smtp::getMimeType(QString ext)
{
//texte
...
bool smtp::read(const QString &waitfor)
{
...
void smtp::error(const QString &msg)
{
    _lastError = msg;
}


void smtp::proxyAuthentication(const QNetworkProxy &, QAuthenticator * authenticator)
{
    *authenticator = _authenticator;
}

void smtp::setProxyAuthenticator(const QAuthenticator &authenticator)
{
