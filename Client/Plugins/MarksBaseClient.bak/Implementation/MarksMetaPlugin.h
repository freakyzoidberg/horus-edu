...
class MarksDataBaseMetaPlugin : public MetaPlugin
{
  Q_OBJECT
  Q_INTERFACES(MetaPlugin)

public:
    inline MarksDataBaseMetaPlugin() {
	  Plugin* p = new MarksDataBasePlugin();
      pluginList.append(p);
  }
};
...
Q_EXPORT_PLUGIN2(MarksDataBaseMetaPlugin, MarksDataBaseMetaPlugin);
