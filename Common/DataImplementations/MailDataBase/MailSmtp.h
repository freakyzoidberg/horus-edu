#ifndef MAILSMTPCLIENT_H
#define MAILSMTPCLIENT_H
...
*/
class MailSmtpClient : public QObject {
    Q_OBJECT
    Q_ENUMS(State);
    Q_FLAGS(Options);
    Q_ENUMS(AuthMode);
...
public:
    MailSmtpClient(QObject *parent = 0);
    ~MailSmtpClient();
...
#endif
    friend class MailSmtpClientPrivate;
};
